...
# module references:
# pwm_modulator, reverb_wrapper, echo_wrapper
...
proc create_hier_cell_axi_perifs { parentCell nameHier } {
  ...
  # Create instance: PWM_gpio, and set properties
  set PWM_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 PWM_gpio ]
  set_property -dict [list \
  ...
  # Create instance: audio_cdma, and set properties
  set audio_cdma [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_cdma:4.1 audio_cdma ]
  set_property CONFIG.C_INCLUDE_SG {0} $audio_cdma


  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins microblaze_0_axi_intc/interrupt] [get_bd_intf_pins interrupt2]
  connect_bd_intf_net -intf_net axi_cdma_0_M_AXI [get_bd_intf_pins audio_cdma/M_AXI] [get_bd_intf_pins smartconnect_1/S01_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_1_M03_AXI [get_bd_intf_pins PWM_gpio/S_AXI] [get_bd_intf_pins smartconnect_1/M03_AXI]
  connect_bd_intf_net -intf_net smartconnect_1_M04_AXI [get_bd_intf_pins echo_gpio/S_AXI] [get_bd_intf_pins smartconnect_1/M04_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_1_M06_AXI [get_bd_intf_pins reverb_gpio/S_AXI] [get_bd_intf_pins smartconnect_1/M06_AXI]
  connect_bd_intf_net -intf_net smartconnect_1_M07_AXI [get_bd_intf_pins audio_cdma/S_AXI_LITE] [get_bd_intf_pins smartconnect_1/M07_AXI]

  # Create port connections
  connect_bd_net -net axi_gpio_0_gpio_io_o  [get_bd_pins PWM_gpio/gpio_io_o] \
  [get_bd_pins pwm_modulator_0/duty_cycle]
  connect_bd_net -net axi_gpio_1_gpio_io_o  [get_bd_pins reverb_gpio/gpio_io_o] \
  [get_bd_pins reverb_wrapper_0/sample_in]
  connect_bd_net -net axi_gpio_1_gpio_io_o1  [get_bd_pins echo_gpio/gpio_io_o] \
  ...
  [get_bd_pins PWM_gpio/s_axi_aclk] \
  ...
  [get_bd_pins audio_cdma/m_axi_aclk] \
  [get_bd_pins audio_cdma/s_axi_lite_aclk]
  ...
  [get_bd_pins PWM_gpio/s_axi_aresetn] \
  ...
  [get_bd_pins audio_cdma/s_axi_lite_aresetn]
...
proc create_hier_cell_perifs { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_pins uart] [get_bd_intf_pins axi_perifs/uart]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_ports uart] [get_bd_intf_pins perifs/uart]
  ...
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs perifs/axi_perifs/audio_cdma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x40000000 -range 0x00010000 -with_name SEG_axi_gpio_0_Reg -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs perifs/axi_perifs/PWM_gpio/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs perifs/axi_perifs/echo_gpio/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs perifs/axi_perifs/reverb_gpio/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces perifs/axi_perifs/audio_cdma/Data] [get_bd_addr_segs perifs/axi_perifs/PWM_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces perifs/axi_perifs/audio_cdma/Data] [get_bd_addr_segs perifs/axi_perifs/axi_timer_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40600000 -range 0x00010000 -target_address_space [get_bd_addr_spaces perifs/axi_perifs/audio_cdma/Data] [get_bd_addr_segs perifs/axi_perifs/axi_uartlite_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces perifs/axi_perifs/audio_cdma/Data] [get_bd_addr_segs perifs/axi_perifs/echo_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces perifs/axi_perifs/audio_cdma/Data] [get_bd_addr_segs perifs/axi_perifs/microblaze_0_axi_intc/S_AXI/Reg] -force
  assign_bd_address -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces perifs/axi_perifs/audio_cdma/Data] [get_bd_addr_segs perifs/axi_perifs/reverb_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces perifs/axi_perifs/audio_cdma/Data] [get_bd_addr_segs perifs/axi_perifs/xadc_wiz_0/s_axi_lite/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces perifs/axi_perifs/audio_cdma/Data] [get_bd_addr_segs perifs/axi_perifs/audio_cdma/S_AXI_LITE/Reg]
