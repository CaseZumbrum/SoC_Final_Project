...
set_property -dict {PACKAGE_PIN C18 IOSTANDARD LVCMOS33} [get_ports {LED_PWM}]
...
set_property -dict {PACKAGE_PIN B15 IOSTANDARD LVCMOS33} [get_ports {vauxp1}]
set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS33} [get_ports {vauxn1}]
